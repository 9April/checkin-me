...
export default function DashboardLayout({
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="px-4 py-2 border-t border-[#F4EBD0]/50">
        <Link 
          href="/privacy" 
          className="flex items-center gap-3 px-5 py-3.5 text-xs font-bold text-[#6B635C] hover:text-[#C5A059] transition-all rounded-2xl"
        >
