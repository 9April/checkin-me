...
export default async function AgreementPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center py-6 sm:py-12 px-0 sm:px-4 no-scrollbar print:m-0 print:p-0 print:min-h-0 print:grid print:place-items-center">
