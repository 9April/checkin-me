...
export default function MediaHeaderPreview({ videoUrl, images }: MediaHeaderPreviewProps) {
  return (
    <div className="w-full max-w-7xl mx-auto bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100 flex flex-col md:flex-row min-h-[800px]">
      ...
      <div className="w-full md:w-1/2 bg-[#1A1A1A] relative flex flex-col justify-center overflow-hidden">
        {videoUrl ? (
          <video
            src={videoUrl}
          ...
          <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-white/50">
            ...
            <p className="font-sans text-sm tracking-widest uppercase">No Video Uploaded</p>
          </div>
        )}
      </div>
